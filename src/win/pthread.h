 ...
 *      code distribution. The list can also be seen at thpthread_mutex_initpthread_mutex_inite
...
#define pthread_cleanup_pop(_execute)                                                   \
    ...
    __finally                                                                           \
    {                                                                                   \
        if (_execute || AbnormalTermination()) { (*(_cleanup.routine))(_cleanup.arg); } \
    }                                                                                   \
    }
...
class PThreadCleanup
{
  ...
  public:
    ...
    ~PThreadCleanup()
    {
        if (executeIt && ((void *)cleanUpRout != (void *)0)) { (void)(*cleanUpRout)(obj); }
    }
